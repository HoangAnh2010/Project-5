...
public class ActionKeywords {
	...
	public static boolean verifyAlertOfEmailinSignInPagehtml5(String value) throws InterruptedException {
    ...
    public static boolean verifyAlertOfPasswordConfinSignUpPage(String value) throws InterruptedException {
        Log.info("Executing: |Verify the alert of password confirm in sign in page|");
        WebElement passwordcf = driver.findElement(By.xpath("//div[@id='invalid_password_feedback']"));
